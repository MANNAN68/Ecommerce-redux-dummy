            ...
            <Navbar className="border-none">
                <NavbarContainer>
                    ...
                    <NavbarList>
                        ...
                        <NavbarItem>
                            <Link to="/cart" className='relative inline-flex items-center text-sm font-medium text-center "'>
                                ...
                                <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-1 -end-2 dark:border-gray-900">{totalCartQty}</div>
